...
class TableViewController: UITableViewController, XMLParserDelegate {
    ...
    func requestMovieInfo() {
        // OPEN API 주소
        let url = "http://openapi.airport.kr/openapi/service/StatusOfPassengerWeahter/getPassengerArrivalsW?serviceKey=1b5aEl3mNADl6xTbBpPZ5nxAhIbUMG%2FA3sOd8VhYij9lGQmihqH8jYh%2FLvqEjPhuZ%2BKbKNpd990YQr3TiME07A%3D%3D&pageNo=1&startPage=1&numOfRows=100&pageSize=10&from_time=1900&to_time=2400&lang=K"
